...
public class Jan_Raycast : MonoBehaviour
{
    ...
    void HandleOnReceiveRaycast(RaycastResultState state, UnityEngine.Vector3 point, Vector3 normal, float confidence)
    {
        if (state == RaycastResultState.SuccessHitObserved)
        {
